...
angular.module('bahmni.ot')
    .service('surgicalAppointmentHelper', [function () {
        ...
        this.getDefaultAttributeTranslations = function () {
            return new Map([['procedure', "OT_SURGICAL_APPOINTMENT_PROCEDURE"],['appointmentType', "OT_APPOINTMENT_TYPE_KEY"],
                ...
                ['otherSurgeon2', "OT_SURGICAL_APPOINTMENT_OTHER_SURGEON_TWO"],
                ['surgicalAssistant', "OT_SURGICAL_APPOINTMENT_SURGICAL_ASSISTANT"], ['surgicalAssistant2', "OT_SURGICAL_APPOINTMENT_SURGICAL_ASSISTANT_TWO"],
                ['surgicalAssistant3', "OT_SURGICAL_APPOINTMENT_SURGICAL_ASSISTANT_THREE"], 
                ['anaesthetist', "OT_SURGICAL_APPOINTMENT_ANAESTHETIST"], ['anaesthetist2', "OT_SURGICAL_APPOINTMENT_ANAESTHETIST_TWO"],
                ['scrubNurse', "OT_SURGICAL_APPOINTMENT_SCRUB_NURSE"], ['scrubNurse2', "OT_SURGICAL_APPOINTMENT_SCRUB_NURSE_TWO"],
                ['circulatingNurse', "OT_SURGICAL_APPOINTMENT_CIRCULATING_NURSE"], ['circulatingNurse2', "OT_SURGICAL_APPOINTMENT_CIRCULATING_NURSE_TWO"],

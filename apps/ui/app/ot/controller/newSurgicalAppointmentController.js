...
angular.module('bahmni.ot')
    .controller('NewSurgicalAppointmentController', ['$scope', '$q', '$window', 'patientService', 'surgicalAppointmentService', 'providerService', 'messagingService', 'programService', 'appService', 'ngDialog', 'spinner', 'queryService', 'programHelper', 'surgicalAppointmentHelper',
        function ($scope, $q, $window, patientService, surgicalAppointmentService, providerService, messagingService, programService, appService, ngDialog, spinner, queryService, programHelper, surgicalAppointmentHelper) {
            var init = function () {
            ...
            $scope.createAppointmentAndAdd = function () {
                if ($scope.surgicalAppointmentForm.$valid) {
                    ...
                    var surgicalAppointmentAttributes = $scope.attributes;
                    surgicalAppointmentAttributes.otherSurgeon2.value = _.isEmpty($scope.attributes.otherSurgeon2.value) ? null : $scope.attributes.otherSurgeon2.value;
                    surgicalAppointmentAttributes.surgicalAssistant.value = _.isEmpty($scope.attributes.surgicalAssistant.value) ? null : $scope.attributes.surgicalAssistant.value;
                    surgicalAppointmentAttributes.surgicalAssistant2.value = _.isEmpty($scope.attributes.surgicalAssistant2.value) ? null : $scope.attributes.surgicalAssistant2.value;
                    surgicalAppointmentAttributes.surgicalAssistant3.value = _.isEmpty($scope.attributes.surgicalAssistant3.value) ? null : $scope.attributes.surgicalAssistant3.value;
                    surgicalAppointmentAttributes.anaesthetist.value = _.isEmpty($scope.attributes.anaesthetist.value) ? null : $scope.attributes.anaesthetist.value;
                    surgicalAppointmentAttributes.anaesthetist2.value = _.isEmpty($scope.attributes.anaesthetist2.value) ? null : $scope.attributes.anaesthetist2.value;
                    surgicalAppointmentAttributes.scrubNurse.value = _.isEmpty($scope.attributes.scrubNurse.value) ? null : $scope.attributes.scrubNurse.value;
                    surgicalAppointmentAttributes.scrubNurse2.value = _.isEmpty($scope.attributes.scrubNurse2.value) ? null : $scope.attributes.scrubNurse2.value;
                    surgicalAppointmentAttributes.circulatingNurse.value = _.isEmpty($scope.attributes.circulatingNurse.value) ? null : $scope.attributes.circulatingNurse.value;
                    surgicalAppointmentAttributes.circulatingNurse2.value = _.isEmpty($scope.attributes.circulatingNurse2.value) ? null : $scope.attributes.circulatingNurse2.value;
                    var appointment = {
                        ...
                        surgicalAppointmentAttributes: surgicalAppointmentAttributes
                    };

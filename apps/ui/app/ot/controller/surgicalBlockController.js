...
angular.module('bahmni.ot')
    .controller('surgicalBlockController', ['$scope', '$q', '$state', '$stateParams', 'spinner', 'surgicalAppointmentService', 'locationService', 'providerService', 'appService', 'messagingService', 'surgicalAppointmentHelper', 'surgicalBlockHelper', 'ngDialog',
        function ($scope, $q, $state, $stateParams, spinner, surgicalAppointmentService, locationService, providerService, appService, messagingService, surgicalAppointmentHelper, surgicalBlockHelper, ngDialog) {
            var init = function () {

                var provider = function () {
                    $scope.appointmentTypes = ["Elective Appointment", "Emergency Appointment"];
                    var params = {v: "custom:(display,person,uuid,retired,attributes:(attributeType:(display),value,voided))"};
                    return providerService.searchSurgeons(params).then(function (response) {
                           $scope.surgeonProvider= response.data;
                    }),
                    providerService.searchNurses(params).then(function (response) {
                        $scope.nurseProvider= response.data.map((e)=>e.FullName);
                    }),
                    providerService.searchAnesthesia(params).then(function (response) {
                        $scope.anesthesiaProvider= response.data.map((e)=>e.FullName);
                    }),
                    providerService.searchAllDoctors(params).then(function (response) {
                        $scope.allDoctors= response.data.map((e)=>e.FullName);
                    });
                };
                provider();
                ...
                var providerNamesFromConfig = $scope.allDoctors;
            ...
            $scope.showSurgicalAssistant2 = false;
            $scope.hideSurgicalAssistant2 = false;
            $scope.showSurgicalAssistant3 = false;
            $scope.hideSurgicalAssistant3 = false;
            $scope.showAnaesthetist2 = false;
            $scope.hideAnaesthetist2 = false;
            $scope.showOtherSurgeon2 = false;
            $scope.hideOtherSurgeon2 = false;
            $scope.showCirculatingNurse2 = false;
            $scope.hideCirculatingNurse2 = false;
            $scope.showScrubNurse2 = false;
            $scope.hideScrubNurse2 = false;
            $scope.ShowHideOtherSurgeon2 = function (param) {
                if (param == "show") {
                    $scope.showOtherSurgeon2 = true;
                    $scope.hideOtherSurgeon2 = !$scope.showOtherSurgeon2;
                    }
                    else if (param == "hide") {
                    $scope.showOtherSurgeon2 = false;
                    $scope.hideOtherSurgeon2 = !$scope.showOtherSurgeon2;
            ...
            $scope.ShowHideScrubNurse2 = function (param) {
                if (param == "show") {
                    $scope.showScrubNurse2 = true;
                    $scope.hideScrubNurse2 = !$scope.showScrubNurse2;
                    }
                    else if (param == "hide") {
                    $scope.showScrubNurse2 = false;
                    $scope.hideScrubNurse2 = !$scope.showScrubNurse2;
            ...
            $scope.ShowHideCirculatingNurse2 = function (param) {
                if (param == "show") {
                    $scope.showCirculatingNurse2 = true;
                    $scope.hideCirculatingNurse2 = !$scope.showCirculatingNurse2;
                    }
                    else if (param == "hide") {
                    $scope.showCirculatingNurse2 = false;
                    $scope.hideCirculatingNurse2 = !$scope.showCirculatingNurse2;
            ...
            $scope.ShowHideSurgicalAssistant2 = function (param) {
                if (param == "show") {
                    $scope.showSurgicalAssistant2 = true;
                    $scope.hideSurgicalAssistant2 = !$scope.showSurgicalAssistant2;
                    }
                    else if (param == "hide") {
                    $scope.showSurgicalAssistant2 = false;
                    $scope.hideSurgicalAssistant2 = !$scope.showSurgicalAssistant2;
            ...
            $scope.ShowHideSurgicalAssistant3 = function (param) {
                if (param == "show") {
                    $scope.showSurgicalAssistant3 = true;
                    $scope.hideSurgicalAssistant3 = !$scope.showSurgicalAssistant3;
                    }
                    else if (param == "hide") {
                    $scope.showSurgicalAssistant3 = false;
                    $scope.hideSurgicalAssistant3 = !$scope.showSurgicalAssistant3;
            ...
            $scope.ShowHideAnaesthetist2 = function (param) {
                if (param == "show") {
                    $scope.showAnaesthetist2 = true;
                    $scope.hideAnaesthetist2 = !$scope.showAnaesthetist2;
                    }
                    else if (param == "hide") {
                    $scope.showAnaesthetist2 = false;
                    $scope.hideAnaesthetist2 = !$scope.showAnaesthetist2;

...
Bahmni.Clinical.DrugSearchResult = (function () {
    var createSynonym = function (drug, synonymName) {
        var name_strength = drug.strength ? drug.name + " " + drug.strength: drug.name;
        var name_strength_dosageForm = drug.dosageForm ? name_strength + " (" + drug.dosageForm.display + ")": name_strength;
        var name_strength_dosageForm_availability = drug.availability ? name_strength_dosageForm + " ⇢ " + drug.availability: name_strength_dosageForm;
        var value = name_strength_dosageForm;
        var label = synonymName ? synonymName + " => " + name_strength_dosageForm_availability : name_strength_dosageForm_availability;
        return {
            label: label,
            value: value,
            drug: drug

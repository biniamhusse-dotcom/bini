...
angular.module('bahmni.clinical')
    .controller('AddTreatmentController', ['$scope', '$http','$rootScope', 'contextChangeHandler', 'treatmentConfig', 'drugService',
        ...
        function ($scope, $http, $rootScope, contextChangeHandler, treatmentConfig, drugService, $timeout,
            ...
            var allowPrescriptionWithOutICD11 = appService.getAppDescriptor().getConfigValue("allowPrescriptionWithOutICD11")
            ...
            $scope.checkPatientDiagnoses = function () {
                const identifier = $scope.patient.identifier;
                $scope.prescriptionAllowed = true;
                var params = {
                    q: "emrapi.checkPatientDiagnoses",
                ...
                if (identifier) {
                    return $http.get('/openmrs/ws/rest/v1/bahmnicore/sql', {
                        ...
                        if (response.data[0].No_of_diag === 0 && !allowPrescriptionWithOutICD11) {
                            $scope.prescriptionAllowed = false;
                            messagingService.showMessage('error', "Prescriptions without a diagnosis are not allowed. Please go to the Diagnosis tab and record the patient's diagnosis first.");
                        }

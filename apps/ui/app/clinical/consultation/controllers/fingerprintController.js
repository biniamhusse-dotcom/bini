...
angular.module('bahmni.clinical')
    .controller('fingerprintController', ['$scope', '$rootScope', '$stateParams', 'conceptSetService',
        ...
        function ($scope, $rootScope, $stateParams, conceptSetService,
            ...
            var extensions = clinicalAppConfigService.getAllConceptSetExtensions("fingerprintPage");
            ...
            var init = function () {
                if (!($scope.allTemplates !== undefined && $scope.allTemplates.length > 0)) {
                    spinner.forPromise(conceptSetService.getConcept({
                        name: "Fingerprint and video upload Templates",

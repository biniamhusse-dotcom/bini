...
angular.module('consultation', ['ui.router', 'bahmni.clinical', 'bahmni.common.config', 'bahmni.common.patient',
    ...
    'bahmni.common.services', 'bahmni.common.models', 'bahmni.common.displaycontrol.referralHistory']);
angular.module('consultation')
    .config(['$stateProvider', '$httpProvider', '$urlRouterProvider', '$bahmniTranslateProvider', '$compileProvider',
        ...
        // @endif
            ...
            .state('patient.dashboard.otform', {
                url: '/otform?dateEnrolled,dateCompleted',
                params: {
                    dashboardCachebuster: null
                },
                views: {
                    'dashboard-header': {
                        templateUrl: 'dashboard/views/otFormHeader.html',
                        controller: 'ConsultationController'
                    },
                    'dashboard-content': {
                        templateUrl: 'dashboard/views/dashboard.html',
            ...
            .state('patient.dashboard.otform.followup', {
                url: '/followup',
                params: {
                    cachebuster: null,
                    lastOpenedTemplate: null
                ...
                views: {
                    'consultation-content': {
                        templateUrl: 'consultation/views/otFollowUp.html',
                        controller: 'OtFollowUpController'
                    }
                }
            })
            .state('patient.dashboard.show.fingerprint', {
                url: '/fingerprint',
                params: {
                    cachebuster: null,
                    lastOpenedTemplate: null
                ...
                views: {
                    'consultation-content': {
                        templateUrl: 'consultation/views/fingerprint.html',

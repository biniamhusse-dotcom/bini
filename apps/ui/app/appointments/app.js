...
angular
    ...
    .config(['$urlRouterProvider', '$stateProvider', '$httpProvider', '$bahmniTranslateProvider', '$compileProvider',
        function ($urlRouterProvider, $stateProvider, $httpProvider, $bahmniTranslateProvider, $compileProvider) {
            ...
            $urlRouterProvider.otherwise('home/manage/appointments/list');
            $urlRouterProvider.when('/home/manage', 'home/manage/appointments/list');
        // @if DEBUG='production'
        ...
        // @endif
            ...
            .state('home', {
                ...
                views: {
                    'additional-header': {
                        templateUrl: 'views/appointmentsHeader.html',
                        controller: 'LiaisonHeaderController'
                    },
                    'mainContent': {
                        template: '<div class="opd-wrapper appointments-page-wrapper">' +
                        '<div ui-view="content" class="opd-content-wrapper appointments-content-wrapper"></div>' +
            ...
            }).state('liaisonHome.manage', {
                url: '/manage',
                views: {
                    'content': {
                        templateUrl: 'views/manage/liaisonManage.html',
                        controller: 'LiaisonScheduleManageController'
                    }
                }
            }).state('liaisonHome.manage.appointments', {
                url: '/appointments',
                params: {
                    filterParams: {},
                    isFilterOpen: true,
                ...
                views: {
                    ...
                    'content@manage': {
                        templateUrl: 'views/manage/allLiaisonAppointments.html',
                        controller: 'AllLiaisonScheduleController'
                    }

                }
            }).state('liaisonHome.manage.appointments.waitingList', {
                url: '/waitingList',
                tabName: 'waitingList',
                params: {
                    viewDate: null,
                ...
                views: {
                    'content@viewAppointments': {
                        templateUrl: 'views/manage/list/liaisonListView.html',
                        controller: 'LiaisonWaitingListViewController'
                    }
                }
            }).state('liaisonHome.manage.appointments.backlogList', {
                url: '/backlogList',
                tabName: 'backlogList',
                params: {
                    viewDate: null,
                ...
                views: {
                    'content@viewAppointments': {
                        templateUrl: 'views/manage/list/liaisonListView.html',
                        controller: 'LiaisonBacklogListViewController'
                    }
                }
            }).state('liaisonHome.manage.appointments.waitingList.newSchedule', {
                url: '/newSchedule',
                views: {
                    'content@appointment': {
                        templateUrl: 'views/manage/newLiaisonSchedule.html',
                        controller: 'LiaisonScheduleCreateController'
                    }
                },
                resolve: {
                    appointmentContext: function (appointmentInitialization, $stateParams) {
            ...
            }).state('liaisonHome.manage.appointments.backlogList.newSchedule', {
                url: '/newSchedule',
                views: {
                    'content@appointment': {
                        templateUrl: 'views/manage/newLiaisonSchedule.html',
            ...
            }).state('liaisonHome.manage.appointments.waitingList.edit', {
                url: '/:uuid',
                views: {
                    'content@appointment': {
                        templateUrl: 'views/manage/newLiaisonSchedule.html',
            ...
            }).state('liaisonHome.manage.appointments.waitingList.view', {
                url: '/:uuid/view',
                views: {
                    'content@appointment': {
                        templateUrl: 'views/manage/viewLiaisonSchedule.html',
                        controller: 'LiaisonScheduleCreateController'
                    }
                },
                resolve: {
            ...
            }).state('liaisonHome.manage.appointments.backlogList.edit', {
                url: '/:uuid',
                views: {
                    'content@appointment': {
                        templateUrl: 'views/manage/newLiaisonSchedule.html',

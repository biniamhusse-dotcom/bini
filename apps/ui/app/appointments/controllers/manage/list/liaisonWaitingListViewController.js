...
angular.module('bahmni.appointments')
    .controller('LiaisonWaitingListViewController', ['$scope', '$state', '$http', '$rootScope', '$translate', '$stateParams', 'spinner',
        ...
        function ($scope, $state, $http, $rootScope, $translate, $stateParams, spinner, appointmentsService, appService, patientService,
            ...
            $scope.$watch(function () {
                ...
                if (newValue !== oldValue) {
                    ...
                    $scope.scheduleCount = $scope.filteredAppointments ? $scope.filteredAppointments.length : 0;
                }
            }, true);

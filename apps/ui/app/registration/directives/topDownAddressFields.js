...
angular.module('bahmni.registration')
    ...
    .controller('TopDownAddressFieldsDirectiveController', ['$scope', 'addressHierarchyService', '$translate', function ($scope, addressHierarchyService, $translate) {
        ...
        $scope.getAmharicTransloation = function (addressLevel) {
            var amhPlaceholder = "";
            if(addressLevel.includes("stateProvince11")){
                amhPlaceholder = "ክልል";
            }
            if(addressLevel.includes("countyDistrict11")){
                amhPlaceholder = "ዞን";
            }
            if(addressLevel.includes("address311")){
                amhPlaceholder = "ወረዳ";
            }
            if(addressLevel.includes("address111")){
                amhPlaceholder = "የቤት ቁጥር";
            }
            if(addressLevel.includes("address211")){
                amhPlaceholder = "ቀበሌ";
            }

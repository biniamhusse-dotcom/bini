...
Bahmni.Common.Domain.AttributeTypeMapper = (function () {
    ...
    AttributeTypeMapper.prototype.mapFromOpenmrsAttributeTypes = function (mrsAttributeTypes, mandatoryAttributes, attributesConfig, defaultLocale, ConditionallyMandatoryPersonAttributes) {
        var attributeTypes = [];
        angular.forEach(mrsAttributeTypes, function (mrsAttributeType) {
            ...
            if (ConditionallyMandatoryPersonAttributes && ConditionallyMandatoryPersonAttributes.includes(attributeType.name)) {
                attributeType.conditionallyRequired = true;
            }

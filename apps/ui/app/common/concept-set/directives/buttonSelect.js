        ...
        return {
            ...
            controller: function ($scope) {
                ...
                $scope.select = function (answer) {
                    if($scope.observation.concept.name != "Confirm Notes") $scope.observation.toggleSelection(answer);
                    if($scope.observation.concept.name == "Confirm Notes"){
                        $scope.$emit("event:confirmSuggestion", $scope.observation.uniqueId);
                    }    

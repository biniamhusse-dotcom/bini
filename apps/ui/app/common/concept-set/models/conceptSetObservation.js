    ...
    Object.defineProperty(this, 'autocompleteValue', {
        ...
        get: function () {
            if (this.value != null && (typeof this.value === "object")) {
                return this.value.shortName ? this.value.shortName : this.value.name;
            }
            else {
                return this.value;
            }
...
Bahmni.ConceptSet.Observation.prototype = {
    ...
    isTime: function () {
        return this.getDataTypeName() === "Time";
    },
    isImage: function () {
    ...
    getControlType: function () {
        if(this.concept.conceptClass=="Graph"){
            return "Graph"
        }
        if(this.concept.conceptClass=="Horizontal Table"){
            return "Horizontal Table"
        }
        if(this.concept.conceptClass=="Contraction Chart"){
            return "contraction"
        }
        if(this.concept.conceptClass=="Multi-Graph"){
            return "Multi-Graph"
        }
        if (this.hidden) {
            return "hidden";

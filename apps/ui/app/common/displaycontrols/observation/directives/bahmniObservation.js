    ...
    .directive('bahmniObservation', ['encounterService', 'observationsService', 'appService', '$q', 'spinner', '$rootScope',
        ...
        function (encounterService, observationsService, appService, $q, spinner, $rootScope,
            ...
            var controller = function ($scope) {
                ...
                // For Er triage print only
                $scope.erTriagePrint = "false"; 
                $scope.erTriagePrint = angular.copy($scope.ertraigeprint); 
                $scope.displayStyle = "normal view"; 
                $scope.displayStyle = angular.copy($scope.displaystyle);

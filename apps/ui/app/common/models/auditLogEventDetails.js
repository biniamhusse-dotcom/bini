Bahmni.Common.AuditLogEventDetails = {
    ...
    "VIEWED_REGISTRATION_ERPATIENT_SEARCH": {eventType: "VIEWED_REGISTRATION_ERPATIENT_SEARCH", message: "VIEWED_REGISTRATION_ERPATIENT_SEARCH"},
    "VIEWED_REGISTRATION_CRPATIENT_SEARCH": {eventType: "VIEWED_REGISTRATION_CRPATIENT_SEARCH", message: "VIEWED_REGISTRATION_CRPATIENT_SEARCH"},
    "VIEWED_TRIAGE_PATIENT_PAGE": {eventType: "VIEWED_TRIAGE_PATIENT_PAGE", message: "VIEWED_NEW_TRIAGE_PATIENT_PAGE_MESSAGE"},   
    "VIEWED_PRESCRIPTION_PAGE": {eventType: "VIEWED_PRESCRIPTION_PAGE", message: "VIEWED_PRESCRIPTION_PAGE"},   
    "VIEWED_ER_TRIAGE_PATIENT_PAGE": {eventType: "VIEWED_ER_TRIAGE_PATIENT_PAGE", message: "VIEWED_NEW_ER_TRIAGE_PATIENT_PAGE_MESSAGE"},
    "ER_TRIAGE_FORM_ACCESSED": {eventType: "ER_TRIAGE_FORM_ACCESSED", message: "ER_TRIAGE_FORM_ACCESSED_PAGE_MESSAGE"},
    "VIEWED_CR_TRIAGE_PATIENT_PAGE": {eventType: "VIEWED_CR_TRIAGE_PATIENT_PAGE", message: "VIEWED_NEW_CR_TRIAGE_PATIENT_PAGE_MESSAGE"},
    "CR_TRIAGE_FORM_ACCESSED": {eventType: "CR_TRIAGE_FORM_ACCESSED", message: "CR_TRIAGE_FORM_ACCESSED_PAGE_MESSAGE"},
    "PRESCRIPTION_FORM_ACCESSED": {eventType: "PRESCRIPTION_FORM_ACCESSED", message: "PRESCRIPTION_FORM_ACCESSED"},
    "ASSIGN_EXAM_ROOM_ACCESSED": {eventType: "ASSIGN_EXAM_ROOM_ACCESSED", message: "ASSIGN_EXAM_ROOM_ACCESSED_PAGE_MESSAGE"},
    "MEDICO_LEGAL_ACCESSED": {eventType: "MEDICO_LEGAL_ACCESSED", message: "MEDICO_LEGAL_ACCESSED_PAGE_MESSAGE"},
    "VIEWED_ER_TRIAGE_PATIENT_PAGE": {eventType: "VIEWED_ER_TRIAGE_PATIENT_PAGE", message: "VIEWED_NEW_ER_TRIAGE_PATIENT_PAGE_MESSAGE"},
    "ER_TRIAGE_FORM_ACCESSED": {eventType: "ER_TRIAGE_FORM_ACCESSED", message: "ER_TRIAGE_FORM_ACCESSED_PAGE_MESSAGE"},
    ...
    "VIEWED_OT_FOLLOWUP_FORM": {eventType: "VIEWED_OT_FOLLOWUP_FORM", message: "VIEWED_OT_FOLLOWUP_FORM_MESSAGE"},
    "VIEWED_FINGERPRINT_FORM": {eventType: "VIEWED_FINGERPRINT_FORM", message: "VIEWED_FINGERPRINT_FORM_MESSAGE"},

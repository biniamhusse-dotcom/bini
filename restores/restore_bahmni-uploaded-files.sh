...
# Usage:
#   bash restore_bahmni-uploaded-files.sh                  # restore latest
#   bash restore_bahmni-uploaded-files.sh 20260605_125336  # restore specific date

VOL_NAME="bahmni-standard_bahmni-uploaded-files"

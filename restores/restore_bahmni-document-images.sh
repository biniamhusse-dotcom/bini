...
# Usage:
#   bash restore_bahmni-document-images.sh                  # restore latest
#   bash restore_bahmni-document-images.sh 20260605_125336  # restore specific date

VOL_NAME="bahmni-standard_bahmni-document-images"

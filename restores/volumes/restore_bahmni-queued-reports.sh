...
# Usage:
#   bash restore_bahmni-queued-reports.sh                  # restore latest
#   bash restore_bahmni-queued-reports.sh 20260605_125336  # restore specific date

VOL_NAME="bahmni-standard_bahmni-queued-reports"

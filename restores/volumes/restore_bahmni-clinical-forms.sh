...
# Usage:
#   bash restore_bahmni-clinical-forms.sh                  # restore latest
#   bash restore_bahmni-clinical-forms.sh 20260605_125336  # restore specific date

VOL_NAME="bahmni-standard_bahmni-clinical-forms"

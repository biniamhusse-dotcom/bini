...
# Usage:
#   bash restore_dcm4chee-archive.sh                  # restore latest
#   bash restore_dcm4chee-archive.sh 20260605_125336  # restore specific date

VOL_NAME="bahmni-standard_dcm4chee-archive"

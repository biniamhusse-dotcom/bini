...
# Usage:
#   bash restore_bahmni-patient-images.sh                  # restore latest
#   bash restore_bahmni-patient-images.sh 20260605_125336  # restore specific date

VOL_NAME="bahmni-standard_bahmni-patient-images"

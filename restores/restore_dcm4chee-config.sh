...
# Usage:
#   bash restore_dcm4chee-config.sh                  # restore latest
#   bash restore_dcm4chee-config.sh 20260605_125336  # restore specific date

VOL_NAME="bahmni-standard_dcm4chee-config"
